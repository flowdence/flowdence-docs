...
- Company name: `Flowdence`
- Privacy contact: `privacy@flowdence.io`
- Address: `Melbourne AU, 3030`

## 2. Data we process

Flowdence apps may process limited identity, configuration, and operational data needed to provide app functionality. Each app-specific disclosure must define exact categories.

## 3. Why we process data

- Deliver and maintain the app service.
...
Requests can be sent to `privacy@flowdence.io`.

## 9. Security

Flowdence applies technical and organizational controls documented in the security policy.
